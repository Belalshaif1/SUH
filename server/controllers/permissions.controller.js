/**
 * @file server/controllers/permissions.controller.js
 * @description Business logic for role permissions and user permission overrides.
 */
...
/** GET /api/permissions/matrix — Super Admin only */
...
module.exports = { getAll, updateBulk, getUserPermissions, updateUserPermissions, getMatrix };
