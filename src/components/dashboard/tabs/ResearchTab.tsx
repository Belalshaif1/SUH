                        ...
                        <CardContent className="flex items-center justify-between p-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${
                                    ...
                                    {r.is_pinned
                                        ? <Pin className="h-5 w-5" />        // Gold pin icon for featured papers
                                        : <FileText className="h-5 w-5" />   // Default document icon
                                    }
                                </div>

                                {/* Title and author metadata — `min-w-0` allows text truncation */}
